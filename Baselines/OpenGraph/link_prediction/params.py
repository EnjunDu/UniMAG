...
def parse_args():
    ...
    parser.add_argument('--num_neg_eval', default=100, type=int, help='number of negative samples for evaluation')
    ...
    # 新增：负样本缓存目录与日志文件
    parser.add_argument('--neg_cache_dir', default=None, type=str, help='directory to load/save precomputed negative samples (defaults to dataset dir)')
    parser.add_argument('--log_file', default=None, type=str, help='path to write console logs (tee to stdout)')
