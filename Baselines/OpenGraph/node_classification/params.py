...
def parse_args():
    ...
    parser.add_argument('--tst_batch', default=64, type=int, help='testing batch size (number of users)')
    ...
    parser.add_argument('--cache_proj', default=0, type=int, help='indicates wheter cache projector and matrices')
    ...
    parser.add_argument('--mask_bat', default=256, type=int, help='batch size for masking')
    ...
    # 新增多GPU和内存优化参数
    parser.add_argument('--multi_gpu', default=0, type=int, help='use multiple GPUs (0=no, 1=yes)')
    parser.add_argument('--gpu_memory_fraction', default=0.8, type=float, help='fraction of GPU memory to use')
    parser.add_argument('--gradient_accumulation_steps', default=1, type=int, help='number of steps to accumulate gradients')
    parser.add_argument('--mixed_precision', default=0, type=int, help='use mixed precision training (0=no, 1=yes)')
    parser.add_argument('--chunk_size', default=10000, type=int, help='chunk size for large matrix operations')
    
    # 新增数据采样参数
    parser.add_argument('--sample_ratio', default=1.0, type=float, help='sampling ratio for dataset (0.1=10% of data)')
    parser.add_argument('--sample_method', default='random', type=str, help='sampling method: random, degree, pagerank, k_hop')
    parser.add_argument('--sample_seed', default=42, type=int, help='random seed for sampling')
    parser.add_argument('--max_nodes', default=100000, type=int, help='maximum number of nodes to use')
    parser.add_argument('--preserve_connectivity', default=1, type=int, help='preserve graph connectivity during sampling (0=no, 1=yes)')
